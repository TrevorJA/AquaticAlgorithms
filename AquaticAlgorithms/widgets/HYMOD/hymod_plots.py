...
from AquaticAlgorithms.widgets.HYMOD.hymod import run_HYMOD
from AquaticAlgorithms.widgets.HYMOD.hymod_components import calculate_error_by_type
...
def plot_HYMOD_results(C_max, B, Alpha, Ks, Kq, N_reservoirs, plot_observed,
    ...
    # Load a test dataset
    data = np.loadtxt('./AquaticAlgorithms/widgets/HYMOD/LeafCatch.dat', unpack = True)[:, 0:365]
